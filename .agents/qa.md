...
- **Validacion de diseno:** Verificar que la UI cumpla con `docs/DESIGN_SYSTEM.md` (Bento Grid, temas, CSS variables, bordes redondeados, sombras sutiles).
...
- **Documentacion base:** `docs/PRD.md`, `docs/DESIGN_SYSTEM.md`, `docs/NEURAL_MAP.md`
...
1. Leer `docs/NEURAL_MAP.md` y `docs/DESIGN_SYSTEM.md` antes de validar.
2. Todo bug encontrado debe reportarse con: archivo, linea, descripcion, pasos para reproducir.
3. Verificar que no haya texto hardcoded en archivos `.razor` (usar `grep`).
